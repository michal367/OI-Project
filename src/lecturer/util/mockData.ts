...
const questionListMock: Question[] = [
    {
        title: "Lynch Street",
        text: "Officia aute cillum ipsum consectetur magna quis aliqua proident ea ipsum.",
        options: [
            {
                index: 0,
                text: "laboris",
    ...
    },
    {
        ...
        text: "Est laboris culpa duis pariatur magna sint aliquip duis qui aliqua.",
        options: [
            {
                index: 0,
                text: "pariatur",
    ...
    {
        title: "Nova Court",
        text: "Deserunt officia do sint reprehenderit do consectetur cupidatat est officia quis et ea adipisicing.",
        options: [
            {
                index: 0,
                text: "sit",
    ...
    {
        title: "Prince Street",
        text: "Laborum nisi eu sint mollit dolore duis amet et adipisicing commodo.",
        options: [
            {
                index: 0,
                text: "est",
    ...
    {
        title: "Box Street",
        text: "Sint fugiat exercitation aliqua incididunt eu sint aliqua incididunt non voluptate ipsum ut labore.",
        options: [
            {
                index: 0,
                text: "excepteur",
    ...
    {
        title: "Hull Street",
        text: "Irure pariatur adipisicing enim fugiat Lorem enim eiusmod laboris sit pariatur incididunt aute.",
        options: [
            {
                index: 0,
                text: "excepteur",
    ...
    {
        title: "Desmond Court",
        text: "Esse cupidatat nostrud do velit enim incididunt laboris Lorem aute ipsum commodo esse magna aliqua.",
        options: [
            {
                index: 0,
                text: "aliqua",
    ...
    {
        title: "Fleet Walk",
        text: "Ea elit reprehenderit do est est adipisicing tempor sint occaecat.",
        options: [
            {
                index: 0,
                text: "fugiat",
    ...
    },
    {
        ...
        text: "Commodo anim quis ipsum culpa excepteur Lorem enim ex irure esse eiusmod nostrud esse nisi.",
        options: [
            {
                index: 0,
                text: "in",
    ...
    {
        title: "Ocean Court",
        text: "Officia officia irure non officia cillum id eiusmod officia consequat.",
        options: [
            {
                index: 0,
                text: "ex",
    ...
    {
        title: "Beard Street",
        text: "Et aliqua eu occaecat sit veniam labore irure minim sint fugiat et adipisicing ex aliquip.",
        options: [
            {
                index: 0,
                text: "consequat",
...
export { studentListMock, questionListMock, timestampMock, scheduledQuizzes };
